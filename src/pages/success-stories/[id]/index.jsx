...
const Galery = ({images, openGalery}) => {
  ...
  return (
    <div className="w-[100vw] h-[100vh] fixed top-0 left-0 flex items-center justify-between bg-[#301F38] z-[10] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
    ...
    statistics: ({ data }) => (
      <Container className="mb-6 px-3 xl:px-0">
        <div className={clsx('w-full grid grid-cols-2  gap-4', {
          ...
          'max-w-[800px] mx-auto grid-cols-2': data.data.length ==2,
    ...
    paragraph: ({ data }) => {
      ...
      return (
        <section className='px-3'>
          { galeryState && <Galery images={data.images} openGalery={openGalery}></Galery> }
          <Container shrink className="flex-col">
            ...
            <div className='mt-6 flex justify-between items-center'>
              ...
              <button className='bg-secondary text-sm smd:text-base text-primary py-2 smd:py-3 font-semibold px-4 smd:px-[28px] flex items-center gap-[10px] rounded-[24px]' onClick={openGalery}>
